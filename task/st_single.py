...
class SpatioTemporal_single(pl.LightningModule):
    def __init__(self, model: nn.Module, hparams: argparse.Namespace, logger=None):
        ...
        self.vision = Vision(save_dir=self.pred_dir, context_length=hparams.context_length, data_name=self.hparams.data_name)
    @staticmethod
    def add_task_specific_args(
        ...
        parser.add_argument("--data_name", type=str, default="huamn")
